...
%readmore`.trimStart(),
  ...
  footer: '',
  after: `ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙʏ ʀɪᴢᴀʟ ꜰʀ`,
}
...
// Tampilkan Tahun Baru
    ...
    let thumb = 'https://telegra.ph/file/7fa9fba55416a8f8ed387.jpg'
    ...
    conn.sendFile(m.chat, './mp3/insecure.opus', '', null, m, true, { type: "audioMessage", ptt: true, waveform: [3,7,29,61,14,15,14,16,10] }, { quoted: m })
  } catch (e) {
...
handler.tags = ['main']
handler.command = /^(allmenu|reely)$/i
